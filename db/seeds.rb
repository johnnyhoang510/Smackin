...
review10 = Review.create!(rating: 4, body: "We got a complimentary Japanese salad, chicken karage, and a regular and black garlic tonkatsu. Chicken was juicy, but maybe could have been a bit more crunchy. The sauce it came with was nice and fit well, like a citrusy aoili. The regular tonkatsu tasted a bit like sweet corn due to the pieces of corn in there. Honestly it was great when we combined it when reheating because those serving sizes were generous :) would come back because I loved having leftovers. A great alternative to marafuku.", user_id: user1.id, business_id: business18.id)
review11 = Review.create!(rating: 3, body: "We enjoyed a decent meal, but certainly have had better. The goat curry was tasty but mostly bones, barely any meat. The lamb Vindaloo was lacking something in flavor and consistency, though decent portions. The mixed tandoor came with 2 small pieces of shrimp, a piece of lamb, and mostly chicken -- all of which were flavorful, but dry. The lamb momos were fine/typical, filled well (I liked the dipping sauce that came with it).", user_id: user1.id, business_id: business19.id)
